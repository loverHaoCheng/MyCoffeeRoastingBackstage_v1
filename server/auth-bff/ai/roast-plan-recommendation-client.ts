...
import {
  ...
  getRoastModelRequestPath,
  supportsRoastModelJsonObjectResponse,
} from './roast-model-request.js';
import type {
  RoastPlanDraft,
...
const requestModelContent = async (
  ...
  if (options.jsonObjectResponse === true && supportsRoastModelJsonObjectResponse()) {
