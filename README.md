...
开发环境下，Vite 会直接挂载同源 `/api/auth/*` 登录态网关，不需要额外启动 `auth:bff:start`。
...
- 服务器运行说明见 [PocketBase/README.md](/Users/keepwatchthemoon/个人/gitProject/MyCoffeeRoastingBackstage_v1/PocketBase/README.md)。
